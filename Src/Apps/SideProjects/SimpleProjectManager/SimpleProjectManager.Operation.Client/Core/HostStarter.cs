...
public partial class HostStarter : BackgroundService
{
    ...
    public HostStarter(IHostApplicationLifetime hostApplicationLifetime, ILogger<HostStarter> logger, ActorSystem system,
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        try
        {
            ...
            var nameActor = _system.ActorOf("ClientNameManager", NameFeature.Create(_configuration.Name));
