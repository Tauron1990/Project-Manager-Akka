...
namespace Tauron.Application.Localizer.UIModels
{
    ...
    public sealed class BuildProjectViewModel : ObservableObject
    {
        ...
        public BuildProjectViewModel(
            IObserver<ProjectBuildpathRequest> updatePath, string? path, string project,
        ...
        {
            var path = _dialogFactory.ShowOpenFolderDialog(
                    null,
                    _localizer.MainWindowBuildProjectFolderBrowserDescription,
                    _source,
    ...
    public sealed class BuildViewModel : UiActor
    {
            ...
            : base(lifetimeScope, dispatcher)
        {
            ...
            Importintegration = RegisterProperty<bool>(nameof(Importintegration))
               ...
               .ThenSubscribe(
                    obs => obs.Select(b => new ChangeIntigrate(b))
            ...
            projectPathSetter.Mutate(workspace.Build).With(
                    bm => bm.ProjectPath,
            ...
            BuildProjectViewModel GetBuildModel(Project p, ProjectFile file) => new(
                projectPathSetter ?? throw new InvalidOperationException("Flow was null"),
                file.FindProjectPath(p),
                p.ProjectName,
                localizer,
                dialogFactory,
                file.Source);
            ...
            this.RespondOnEventSource(
                workspace.Projects.NewProject,
                project => projectsSource.Add(GetBuildModel(project.Project, workspace.ProjectFile)));
            this.RespondOnEventSource(
                workspace.Projects.RemovedProject,
                project =>
                {
