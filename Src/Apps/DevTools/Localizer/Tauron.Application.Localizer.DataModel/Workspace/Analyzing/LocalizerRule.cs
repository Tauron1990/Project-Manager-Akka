...
namespace Tauron.Application.Localizer.DataModel.Workspace.Analyzing
{
    public abstract class LocalizerRule : RuleBase<ProjectFileWorkspace, MutatingContext<ProjectFile>>
    {
        ...
        {
            Actor = actor;
            actor.RespondOnEventSource(Workspace.Source.ProjectReset, rest => SendIssues(ValidateAll(rest, ExpandedReceiveActor.ExposedContext), ExpandedReceiveActor.ExposedContext));
