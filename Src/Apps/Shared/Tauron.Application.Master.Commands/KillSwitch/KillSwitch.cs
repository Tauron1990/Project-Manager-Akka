    ...
    public static class KillSwitch
    {
        ...
        public sealed class KillSwitchFeature : ActorFeatureBase<KillSwitchFeature.KillState>
        {
            ...
            protected override void Config()
            {
                ...
                Receive<RespondRegistration>(obs => obs.Do(r => Log.Info($"Set Killswitch Actor Type {r.Event.RecpientType} {Sender.Path}"))
                                                       .Select(r =>
                                                               {
                                                                   ...
                                                                   return state with {Actors = state.Actors.Replace(ele, ele with {RecpientType = respondRegistration.RecpientType})};
                                                               }));
            ...
            public sealed record ActorElement(IActorRef Target, KillRecpientType RecpientType = KillRecpientType.Unkowen)
            {
