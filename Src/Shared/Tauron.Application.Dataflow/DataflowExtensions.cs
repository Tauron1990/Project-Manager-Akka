...
namespace Tauron.Application.Dataflow
{
    public static class Observable
    {
        ...
        //		public static IObservable<IDictionary<TKey, TSource>> ToDictionary<TSource, TKey>(this IObservable<TSource> source, Func<TSource, TKey> keySelector) where TKey : notnull
        //		{
        //			if (source == null)
        //			{
        //				throw new ArgumentNullException("source");
        ...
        //		public static IObservable<IDictionary<TKey, TSource>> ToDictionary<TSource, TKey>(this IObservable<TSource> source, Func<TSource, TKey> keySelector, IEqualityComparer<TKey> comparer) where TKey : notnull
        //		{
        //			if (source == null)
        //			{
        //				throw new ArgumentNullException("source");
        ...
        //		public static IObservable<IDictionary<TKey, TElement>> ToDictionary<TSource, TKey, TElement>(this IObservable<TSource> source, Func<TSource, TKey> keySelector, Func<TSource, TElement> elementSelector) where TKey : notnull
        //		{
        //			if (source == null)
        //			{
        //				throw new ArgumentNullException("source");
        ...
        //		public static IObservable<IDictionary<TKey, TElement>> ToDictionary<TSource, TKey, TElement>(this IObservable<TSource> source, Func<TSource, TKey> keySelector, Func<TSource, TElement> elementSelector, IEqualityComparer<TKey> comparer) where TKey : notnull
        //		{
        //			if (source == null)
        //			{
        //				throw new ArgumentNullException("source");
