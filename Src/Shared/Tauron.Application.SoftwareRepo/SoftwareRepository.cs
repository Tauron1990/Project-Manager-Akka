...
namespace Tauron.Application.SoftwareRepo
{
    ...
    public sealed class SoftwareRepository : Workspace<SoftwareRepository, ApplicationList>
    {
        ...
        public ApplicationList ApplicationList { get; private set; } = new(string.Empty, string.Empty, ImmutableList<ApplicationEntry>.Empty);
                                                ...
                                                var newData = mc.Data with
                                                              {
                                                                  ...
                                                                  mc.Data.ApplicationEntries.Add(
                                                                      new ApplicationEntry(name, version, id, 
                                                                                           ImmutableList<DownloadEntry>.Empty.Add(new DownloadEntry(version, url)), originalRepository, brnachName))
                                                              };
