...
namespace Tauron.Application.Files.Serialization.Core.Impl
{
    internal sealed class BinarySerializer : ISerializer
    {
        ...
        public BinarySerializer(BinaryFormatter formatter) => _formatter = formatter;

        public AggregateException? Errors => _formatter == null
            ? new AggregateException(new SerializerElementNullException("Formatter"))
            : null;
