...
namespace Tauron.Application.Files.VirtualFiles
{
    ...
    {
        public static IVirtualFileSystem CreateInMemory(string name, DataDirectory? directory = null) => new InMemoryFileSystem(string.Empty, name, directory ?? new DataDirectory(name));
